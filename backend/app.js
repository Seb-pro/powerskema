...
app.use("/api/events", (req, res, next) => {
  const events = [
    ...
    },
    {
      ...
      subject: "Workshop",
      description:
        "Workshop i Amazons AWS. Gratis frokost",
    },
    {
      eventid: 7,
      title: "Fredagsbar i Bygning D",
      ...
      category: "Events",
      subject: "Fest",
      description: "Fredagsbar med Halloween tema. Happy hour imellem kl. 15-16",
    },
    {
      eventid: 8,
    ...
    },
    {
      ...
      subject: "Frontend/Backend",
      description:
        "Lav en film-streaming tjeneste",
    },
    {
      eventid: 11,
      ...
      subject: "DB og F/B",
      description:
        "Arbejd videre på tidligere projekt, men tilføj en API",
    },
    {
      eventid: 12,
      ...
      subject: "Database",
      description:
        "Aflever evaluering af faget Database",
    },
    {
      eventid: 13,
    ...
    },
    {
      ...
      subject: "Database",
      description:
        "Se de tre Hadoop-videoer om MapReduce",
    },
    {
      eventid: 15,
      ...
      subject: "UX",
      description:
        "Læs de to kapitler, og tag noter til",
    },
  ];
  res.status(200).json({
